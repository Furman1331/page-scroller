...
export type IEventHandlerMap<Events extends Record<TEmitterEventType, unknown>> = Map<keyof Events | '*', TEmitterHandlerList<Events[keyof Events]> | TEmitterWildcardHandlerList<Events>>;
